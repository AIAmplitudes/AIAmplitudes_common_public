...
import random
from AIAmplitudes.rels_utils import get_coeff_from_word,check_slot,find_all,alphabet,count_appearances
from AIAmplitudes.commonclasses import fastRandomSampler
